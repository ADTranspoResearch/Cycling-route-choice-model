...
sys.path.append(r"C:\Program Files\QGIS 3.34.3\apps\qgis\python\plugins")
...
from import_omm_algorithms import OMMProvider 
...
qgs.setPrefixPath(r"C:\Program Files\QGIS 3.30.3\apps\qgis", True)

print("QGIS prefix path:", qgs.prefixPath())
qgs.initQgis()
